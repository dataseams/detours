...
const testimonial_1_text =
  "This travel agent and concierge rolled into one will construct a highly detailed itinerary for you that includes the best restaurants, sights, and events for your trip.";
const testimonial_2_text =
  "This travel agent and concierge rolled into one will construct a highly detailed itinerary for you that includes the best restaurants, sights, and events for your trip.";
const testimonial_3_text =
  "This travel agent and concierge rolled into one will construct a highly detailed itinerary for you that includes the best restaurants, sights, and events for your trip.";
...
const Index = props => (
  <Layout>
    <div id="landing-1">
      ...
      <p id="subtitle">
        Fill out a short questionnaire and get a personalized itinerary in{" "}
        <b>5 minutes.</b>
      </p>
      <Link href="/survey">
      ...
      <div id="testimonials">
        ...
        <div id="testimonials-container">
          <div id="testimonial-1" className="testimonial-container">
            ...
            <div>
              <div>
                <img src="/static/left_quotes.svg"></img>
              </div>
              <div className="testimonial-content">{testimonial_1_text}</div>
              <div>
                <img src="/static/right_quotes.svg"></img>
              </div>
            </div>
            <div className="testimonial-signature">
              {testimonial_1_signature}
            </div>
          </div>
