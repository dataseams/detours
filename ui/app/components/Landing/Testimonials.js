    ...
    <Card key={index} className={classes.card}>
      ...
      <CardContent className={classes.content}>
        <Grid className={classes.gridQuote}>
          ...
          <Typography className={classes.body}>{step.quote}</Typography>
          <img
            src="/static/right_quotes.svg"
            className={classes.quoteDown}
          ></img>
          <Typography className={classes.signature}>{step.name}</Typography>
        </Grid>
      </CardContent>
    </Card>
  );
...
function Testimonials(props) {
  ...
  return isMobile ? (
    <Box className={classes.root}>
      <Typography className={classes.h2}>What our customers say</Typography>
