...
function Pricing(props) {
  ...
  return isMobile ? (
    <Box className={classes.root} id="pricing">
      ...
      <br />
      <Typography className={classes.body}>
        This small fee will save you an average of 20 to 30 hours of planning
        your vacation and will give you access to an itinerary of top-rated
        experiences personalized specifically for you.
      </Typography>
